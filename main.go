...
import (
	...
	"serverless.domain/k8s-operator/controllers"
...
func init() {
	...
	utilruntime.Must(serverlessdevsv1.AddToScheme(scheme))
...
func main() {
	...
	flag.DurationVar(&syncPeriod, "informer-re-sync-interval", 2*time.Minute,
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "9bdd0a8b.serverless.domain",
